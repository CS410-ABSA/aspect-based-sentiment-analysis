...
if not os.path.exists("./models/word2vec.model.trainables.syn1neg.npy"):
    print("Retrieving 5")
...
if not os.path.exists("./models/word2vec.model.wv.vectors.npy"):
    print("Retrieving 6")
